...
INSERT INTO `sys_glue_version` VALUES (1891035278350082049, 'import com.hxh.job.common.JobHandler;\n\npublic class Demo extends JobHandler {\n\n    @Override\n    public void execute() throws Exception {\n        throw new RuntimeException(\"错误日志查看测试\");\n    }\n}', 'init', 'JAVA', '1111111111111111111', '2025-02-16 16:08:56');
...
INSERT INTO `sys_scheduled` VALUES (1890305589801127937, 'Demo模版', 1890212284891422722, NULL, '[{\"key\":\"id\",\"value\":\"123456789098765432\"}]', '0 0 0/1 * * ?', 'com.hxh.job.task.scheduled.Demo', 0, 1, 'TEMPLATE', '1339985116268593152', '2025-02-14 15:42:27', '1340621657760333824', '2025-02-16 09:51:50');
INSERT INTO `sys_scheduled` VALUES (1890663872508481538, 'glue测试', 1890212284891422722, NULL, 'import com.hxh.job.common.JobHandler;\nimport com.hxh.job.task.topic.ComponentBean;\nimport org.springframework.beans.factory.annotation.Autowired;\n\npublic class Demo extends JobHandler {\n    @Autowired\n    private ComponentBean componentBean;\n  \n    @Override\n    public void execute() throws Exception {\n        System.out.println(\"do something...\");\n        componentBean.invoke();\n    }\n}', '33 10/15 * * * ?', '', 0, 1, 'GLUE', '1340343399005290496', '2025-02-15 15:26:08', '1340460784580296704', '2025-02-15 23:12:35');
INSERT INTO `sys_scheduled` VALUES (1891035278350082049, 'glue测试2', 1890212284891422722, NULL, 'import com.hxh.job.common.JobHandler;\n\npublic class Demo extends JobHandler {\n\n    @Override\n    public void execute() throws Exception {\n        throw new RuntimeException(\"错误日志查看测试\");\n    }\n}', '57 0/15 * * * ?', '', 0, 1, 'GLUE', '1340714804834205696', '2025-02-16 16:01:58', '1340716258546417664', '2025-02-16 16:07:45');
